...
export default function RejectKYCModal({ open, onClose, onConfirm }) {
  ...
  return (
    <Modal open={open} onClose={onClose} title="Reject KYC Documents">
      <p className="text-sm text-gray-500">
        Are you sure you want to reject all KYC documents from this user. This
        action cannot be undone - customer would have to create a new
        application.
      </p>
      <div className="mt-5">
